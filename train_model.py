...
csv_file_path = r'C:\Users\AGNIBH\OneDrive\Desktop\CAR PRICE Predictor with ML\car_data.csv'
...
df['fuel_type'] = label_encoder_fuel_type.fit_transform(df['fuel_type'])
...
joblib.dump(label_encoder_name, 'label_encoder_name.pkl')
joblib.dump(label_encoder_company, 'label_encoder_company.pkl')
joblib.dump(label_encoder_fuel_type, 'label_encoder_fuel_type.pkl')
